...
Como usar:
1. Abra a planilha do simulador () no Microsoft Excel ou acesse o artefato interativo HTML em um navegador web.
2. Insira ou altere o número de alunos matriculados em cada etapa e modalidade de ensino nas células/campos de entrada.
4. Ajuste os dias letivos ou parâmetros de valor per capita diário, caso necessário.
5. Observe a atualização automática dos valores totais de repasse calculados com as fórmulas (SE, PROCV, SOMARPRODUTO e Tabela de Dados) e no painel visual do artefato.
